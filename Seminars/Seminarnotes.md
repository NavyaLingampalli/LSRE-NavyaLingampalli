...
In my opinion, this approach of prioritizing the requirements is well suited for the projects with less number of requirements. It is difficult to apply this approach in the case of large scale requirements engineering as it does not take interdependencies into account. 
References:
